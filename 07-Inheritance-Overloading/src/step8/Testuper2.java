...
class GrandParent{ //extends Object -> 상속 관계가 없는 클래스는  extends Object가 자동삽입
	public GrandParent() { //super() :가 자동삽입 -> 모든 자바 클래스의 root or 최상위 클래스인 Object 의 생성자를 호출해 Object 객체를 생성
...
public class Testuper2 {
	public static void main(String[] args) {
		new Child(); //자식 객체를 생성하면 부모객체-> 자식객체 순으로 생성한다.
	}
}
